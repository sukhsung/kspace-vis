function [kx,ky,kz, rad_per_ang_per_px] = tilt_to_k_v2 (resM, posxy, kev, tilts, tilt_angle, first_orders, lattice_param, shifts )
    ...
    for peak = peaks
        ...
        if shifts
            ...
            kx(peak,:) = rad_per_ang_per_px*(posxy(peak,1) - center_pos(1,1));
            ky(peak,:) = rad_per_ang_per_px*(posxy(peak,2) - center_pos(2,1));
            norm(kx+ky,2)
        end
